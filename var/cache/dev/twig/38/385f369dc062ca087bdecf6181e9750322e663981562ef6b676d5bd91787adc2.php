...
class __TwigTemplate_ae5c8f2de77d86786ec9b49397d55353306749c23a3005f66419b9cabbbf3f10 extends \Twig\Template
{
    private $source;
    ...
    <table class=\"table\">
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["user"]) {
            ...
            echo "</td>
                <td>";
            // line 25
            ((twig_get_attribute($this->env, $this->source, $context["user"], "creationdate", [], "any", false, false, false, 25)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "creationdate", [], "any", false, false, false, 25), "Y-m-d H:i:s"), "html", null, true))) : (print ("")));
            echo "</td>
                <td>";
            // line 26
            ((twig_get_attribute($this->env, $this->source, $context["user"], "updatedate", [], "any", false, false, false, 26)) ? (print (twig_escape_filter($this->env, twig_date_format_filter($this->env, twig_get_attribute($this->env, $this->source, $context["user"], "updatedate", [], "any", false, false, false, 26), "Y-m-d H:i:s"), "html", null, true))) : (print ("")));
            echo "</td>
                <td>
                    <a href=\"";
            // line 28
...
";
    ...
    {
        return array (  141 => 40,  136 => 37,  127 => 33,  118 => 29,  114 => 28,  109 => 26,  105 => 25,  101 => 24,  97 => 23,  93 => 22,  90 => 21,  85 => 20,  69 => 6,  63 => 5,  51 => 3,  35 => 1,);
    }
...
{% endblock %}
", "user/index.html.twig", "C:\\xampp\\htdocs\\symfony4\\user\\templates\\user\\index.html.twig");
    }
}
